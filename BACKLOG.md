...
**Confirmed working** on macOS: live reload fires in VS Code's Simple Browser. Easiest way in — **⌘/Ctrl-click the printed `http://localhost:…` URL** in the VS Code terminal; it opens directly in a Simple Browser tab (no command-palette step needed).
